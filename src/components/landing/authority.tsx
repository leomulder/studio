      ...
      <div className="container mx-auto max-w-4xl px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="bg-card p-6 rounded-lg border">
            ...
            <div className="mt-4 text-center font-semibold text-muted-foreground/80 text-sm">
              <p>Sans rhétorique.</p>
        ...
        <div className="mt-16 text-center">
            <p className="font-headline text-xl md:text-2xl max-w-3xl mx-auto tracking-wide">
